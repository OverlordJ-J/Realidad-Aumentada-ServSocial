...
namespace I_wanna_die
{
    public partial class Form1 : Form
    {
        ...
        private void glControl1_Paint(object sender, PaintEventArgs e)
        {
            ...
            Cursor C1 = new Cursor(-0.0, 100.0, 5.0*Math.PI/2);
            //Cursor C2 = new Cursor( 200.0, 200.0, -2.0 * Math.PI/3.0);
            Cursor C2 = new Cursor(200.0, 200.0, -2.0*Math.PI / 2.0);
            Cursor C3 = new Cursor(0.0, h, -Math.PI/2.0);
            ...
            Peano(iteracion, C1, 600.0);
            Peano(iteracion, C2, 600.0);
            Peano(iteracion, C3, 600.0);
